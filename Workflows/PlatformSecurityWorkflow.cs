...
{
    internal sealed class PlatformSecurityWorkflow
    {
        ...
        public PlatformSecurityWorkflow(Window window)
        {
            _window = window;
        }
        ...
        public void Execute()
        {
            ...
            CorrectionWaiter.WaitForCompletion(_window, "Platform Security correction");

            var securityItems = GetQualificationItems();
